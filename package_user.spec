...
a = Analysis(
    ...
    datas=[
        ...
        ('research/edition_samples/cet4_phrases.json', 'research/edition_samples'),
        ('research/edition_samples/cet4_irregular_verbs.json', 'research/edition_samples'),
        ('research/edition_samples/cet6_sample.json', 'research/edition_samples'),
        ('research/edition_samples/cet6_phrases.json', 'research/edition_samples'),
        ('research/edition_samples/cet6_irregular_verbs.json', 'research/edition_samples'),
