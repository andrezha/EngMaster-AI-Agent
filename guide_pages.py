...
COMMON_QUESTIONS = (
    ...
    (
        "怎样购买英语正式版？",
        "从免费体验点击“前往购买正式版”，进入正式版管理页面；点击统一的“前往淘宝购买”，在淘宝商品规格中选择单版本或组合版本并付款。当前只有高考英语正式版开放，其他组合将在相关版本完成后上线。将淘宝订单号粘贴到软件并生成客服核验信息，再从对应订单联系卖家，同时发送订单卡片。客服需要人工核对，请耐心等待；收到累计激活码后回到软件粘贴并立即激活。升级购买采用相同流程，新码会保留原有权限并加入新增权限。",
    ),
)
        ...
        return [
            ...
            (
                ...
                [
                    ...
                    "完成付款后，把淘宝订单号粘贴到页面，再点击“生成并复制客服核验信息”。",
                    "从对应订单联系卖家，同时发送订单卡片和复制好的订单号、机器码信息。",
                    "客服核对订单号、付款状态和商品规格后生成权限；机器码本身不代表购买版本。",
