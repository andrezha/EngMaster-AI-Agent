...
OUT = ROOT / "soft_copyright_yingsicheng_v1_package"
DOCS = OUT / "01_正式文档"
SOURCE = OUT / "02_源代码材料"
CHECK = OUT / "03_待填写与截图清单"
ARCHIVE = OUT / "99_草稿备份"
SCREENSHOT_SRC = ROOT / "soft_copyright_yingsicheng_materials" / "screenshots"
SCREENSHOT_OUT = DOCS / "截图"

TODAY = "2026-08-11"
SOFTWARE_NAME = "英思成英语词汇复习软件"
SHORT_NAME = "英思成"
VERSION = "V1.0"
VOCABULARY_SCOPE_NOTICE = (
    "本软件用于英语词汇复习、主动回忆验证和薄弱词巩固，词汇及学习内容由开发者结合"
    "不同学习阶段的一般词汇需求独立整理编排。本软件不是升学考试服务，也并非教育主管"
    "部门、学校、考试机构或教材出版社的官方指定软件。"
)
...
def build_user_manual():
    ...
    _p(
        doc,
        f"{SOFTWARE_NAME}是一款 Windows 桌面端英语词汇复习软件。软件通过词表学习、"
        "普通闯关、个人错词表、错词闯关和下一轮复测形成闭环学习流程，并提供自主词库、"
        "短语与不规则动词训练、轮次学习记录以及资料导出功能。",
    )
    _p(
        doc,
        "V1.0 提供初中、高中、大学英语四级、大学英语六级和考研五个级别的30词免费体验。"
        "初中英语核心词汇版和高中3800词汇版已经完成并开放；其他正式版仍处于开发阶段。",
    )
    _p(doc, VOCABULARY_SCOPE_NOTICE)
    ...
    rows = [
        ...
        ("运行方式", "单机免安装运行；体验无需激活，正式版采用本地单机激活。"),
    ]
    ...
    _numbered(doc, [
        ...
        "页面展示各正式版的开放状态；V1.0 开放初中英语核心词汇版和高中3800词汇版，其他正式版显示“开发中”。",
    ...
    _screenshot(doc, "04_高中词汇表.png", "高中3800词汇表")
    ...
    _screenshot(doc, "05_高中词汇闯关.png", "高中3800词汇闯关")
    ...
    _p(
        ...
        "各体验级别与正式版数据相互隔离。清理系统文件、重装系统、磁盘损坏或误删"
    ...
    for question, answer in [
        ...
        ("部分正式版为什么不能购买", "V1.0 开放初中和高中正式版；其他正式版仍在开发中，可使用对应30词体验。"),
    ...
    _bullets(doc, [
        ...
        "界面中初中和高中正式版应显示可购买或已解锁，其他正式版应显示开发中。",
...
def build_application_reference():
    ...
    _p(
        doc,
        "本软件提供初中、高中、大学英语四级、大学英语六级和考研五个级别的英语词汇体验，"
        "通过词表学习、普通闯关、个人错词表、错词闯关和轮次复测形成学习闭环，并提供自主词库、"
        "短语与不规则动词训练、学习记录及资料导出。V1.0 开放初中英语核心词汇版和高中3800词汇版，"
        "采用单机离线授权；其他正式版仍在开发中。",
    )
    _p(
        doc,
...
def backup_drafts():
    draft = ROOT / "soft_copyright_yingsicheng_materials"
    if draft.exists():
